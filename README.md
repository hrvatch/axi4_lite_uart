...
0 = No TX FIFO overflow error has occured
1 = TX FIFO overflow error has occured
...
0 = No TX FIFO underflow error has occured
1 = TX FIFO underflow error has occured
...
0 = Number of bytes in the TX FIFO is greater then the threshold value.
1 = Number of bytes in the TX FIFO is less or equal then the threshold value.
...
0 = Number of bytes in the RX FIFO is less than the threshold value.
1 = Number of bytes in the RX FIFO is equal or greate than the threshold value.
...
0 = Generation of a particular interrupt is disabled
1 = Generation of a particular interrupt is enabled
